...
<button onclick="javascript:divStudentAdmin()">Student Admin</button>
            ...
            <div class="col-md-8">
              ...
              <div class="AdminInstructorView" id="divInstructor" style="display:none">
...
<div id="divNewIntake" style="display:none">
  <form action="/newintake" method="post">
    ...
    <div class="StudentAdmin" id="StudentAdmin">
          <iframe src="/student/" class="AdminStudentIframe"
          id="AdminStudentIframe"></iframe>
    </div>
