...
class QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Question::create([
            ...
            ($k =new Answer(['Answer' => '10'])),
            new Answer(['Answer' => '3']),
            new Answer(['Answer' => '5'])    
        ])[0]->Question->correctAnswer()->associate($k)->save();
        Question::create([
            ...
            ($k = new Answer(['Answer' => '“The Arctic” Land in Inuktitut language']))    
        ])[0]->Question->correctAnswer()->associate($k)->save();
        Question::create([
        ...
        Question::create([
            ...
            ($k = new Answer(['Answer' => 'British-Columbia'])),
        ...
        Question::create([
            ...
            ($k= new Answer(['Answer' => 'Natural resources, manufacturing and services.'])),
        ...
        Question::create([
            ...
            ($k =new Answer(['Answer' => 'Canadian Consitution.'])),
        ...
        Question::create([
            ...
            ($k = new Answer(['Answer' => 'Newfoundland']))    
        ])[0]->Question->correctAnswer()->associate($k)->save();
        Question::create([
        ...
        Question::create([
            ...
            ($k = new Answer(['Answer' => 'November 11th every year.'])),
        ...
        Question::create([
            ...
            ($k = new Answer(['Answer' => 'Obeying the law, getting a job in the government and serving in Canadian Forces.'])),
